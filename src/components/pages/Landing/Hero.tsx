...
const Hero = () => {
  return (
    <section className="absolute z-10  w-full px-4 pt-56 text-white   ">
      <div className=" flex  w-full max-w-sm flex-col md:mx-auto md:max-w-sm">
        <h1 className="flex flex-col justify-start  md:justify-center ">
          <span className="pb-2 font-serif text-2xl sm:text-3xl md:text-4xl">
            Get ready for ...
          </span>
